...
?>
    ...
    <body>
        ...
        <?php
        $name = $email = $message = $human = $result = "";
...
// If there are no errors, send the email
        ...
        <div class="container bg-grey text-right" id="contact">
                    ...
                    <form class="form-horizontal" role="form" method="post" action="home.php">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-sm-offset-2">
                                <input type="text" class="form-control text-right" id="name" name="name" placeholder="الأسم الثلاثي" value="<?php echo htmlspecialchars($_POST['name']); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-sm-offset-2">
                                <input type="email" class="form-control text-right" id="email" name="email" placeholder="example@domain.com" value="<?php echo htmlspecialchars($_POST['email']); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-sm-offset-2">
                                <textarea class="form-control text-right" rows="4" name="message"placeholder="رسالتك"><?php echo htmlspecialchars($_POST['message']); ?></textarea>
